...
/*
@Composable
fun TicketDetailsSmall(setState: (Boolean) -> Unit, ticket: Ticket, auth: UserProvider) {
...
@Composable
fun TicketDetails(setState: (Boolean) -> Unit, ticket: Ticket, auth: UserProvider) {
    val ratingVal = remember { mutableStateOf(ticket.rating.toInt()) }
